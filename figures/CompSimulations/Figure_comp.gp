...
plot 'NamPRTkmscan_compNADANamPRT_0.txt' using 5:($9*1000) title '10%NADA' w lines lc rgb "#AA0000" lt 1 lw 2, 'NamPRTkmscan_compNADANamPRT_0.txt' using 5:($8*1000) title 'NamPRT' w lines lc rgb "#00AA00" lt 1 lw 2;
