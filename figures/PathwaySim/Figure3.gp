...
title 'NamPT only' w lines lt rgb "#00AA00" lw 2, \
'simulations/NampRTNNMT_celldev_10_100.txt' using ($6*3600):($8*1000) \
title 'NamPT and NNMT' w lines  lt  rgb "#3333FF" lw 2, \
'simulations/NampRTNNMT_celldev_10_400.txt' using ($6*3600):($8*1000) \
title '4 {/Symbol \264} NamPT and NNMT' w lines lc rgb "#3333FF" dt 2 lw 2;
