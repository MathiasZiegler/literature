...
plot 'simulations/NADANamPRTNNMT_celldev_10_0_0.txt' using ($6*3600):($8*1000) title 'NADA only' w lines lc rgb "#AA0000" lt 1 , 'simulations/NADANamPRTNNMT_celldev_10_10_0.txt' using ($6*3600):($8*1000) title 'NADA+NNMT' w lines lc rgb "#AA00AA" lt 1, 'simulations/NADANamPRTNNMT_celldev_0_0_100.txt' using ($6*3600):($8*1000) title 'NamPRT only' w lines lc rgb "#00AA00" lt 1, 'simulations/NADANamPRTNNMT_celldev_0_10_100.txt' using ($6*3600):($8*1000) title 'NamPRT+NNMT' w lines lc  "#3333FF" lt 1;
