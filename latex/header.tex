...
\noindent
Mathias Bockwoldt\textsuperscript{1}, Dorothée Houry\textsuperscript{2}, Marc Niere\textsuperscript{2}, Toni I. Gossmann\textsuperscript{3}, Ines Reinartz\textsuperscript{4}, Alexander Schug\textsuperscript{4,5}, Mathias Ziegler\textsuperscript{2}, and Ines Heiland\textsuperscript{1,§}
...
\noindent
\textsuperscript{4}Karlsruhe Institute of Technology (KIT), Steinbuch Centre for Computing (SCC), Helmholtz Young Investigator Group Leader, Multiscale Biomolecular Simulation, Hermann-von-Helmholtz-Platz 1, 76344 Eggenstein-Leopoldshafen, Germany

\noindent
\textsuperscript{5}Research Center Juelich,52425 Juelich, Germany
